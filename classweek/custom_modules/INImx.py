...
class INImx():
    ...
    def start_action(self):
        ...
        self.logger.debug('P_RMESG1 : ' + self.rmesg1.decode('euc-kr').encode('utf-8'))
    ...
    def do_pay(self):
        ...
        result_p_tid = params_dict.get('P_TID', None)
        result_p_type = params_dict.get('P_TYPE', None)
        result_p_auth_dt = params_dict.get('P_AUTH_DT', None)
        result_p_mid = params_dict.get('P_MID', None)
        result_p_oid = params_dict.get('P_OID', None)
        result_p_amt = params_dict.get('P_AMT', None)
        result_p_uname = params_dict.get('P_UNAME', None)
        result_p_rmesg1 = params_dict.get('P_RMESG1', None)
        result_p_rmesg2 = params_dict.get('P_RMESG2', None)
        result_p_noti = params_dict.get('P_NOTI', None)
        result_p_fn_cd1 = params_dict.get('P_FN_CD1', None)
        result_p_auth_no = params_dict.get('P_AUTH_NO', None)
        result_p_card_issuer_code = params_dict.get('P_CARD_ISSUER_CODE', None)
        result_p_card_num = params_dict.get('P_CARD_NUM', None)
        result_p_card_member_num = params_dict.get('P_CARD_MEMBER_NUM', None)
        result_p_card_purchase_code = params_dict.get('P_CARD_PURCHASE_CODE', None)
        result_p_card_prtc_code = params_dict.get('P_CARD_PRTC_CODE', None)
        result_p_hpp_corp_ = params_dict.get('P_HPP_CORP', None)
        result_p_vact_num = params_dict.get('P_VACT_NUM', None)
        result_p_vact_date = params_dict.get('P_VACT_DATE', None)
        result_p_vact_time = params_dict.get('P_VACT_TIME', None)
        result_p_vact_name = params_dict.get('P_VACT_NAME', None)
        result_p_vact_bank_code = params_dict.get('P_VACT_CODE', None)
        ...
        self.logger.debug('P_HPP_CORP : ' + result_p_hpp_corp_)
