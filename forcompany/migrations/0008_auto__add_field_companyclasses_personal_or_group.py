...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyClasses.personal_or_group'
        db.add_column(u'forcompany_companyclasses', 'personal_or_group',
                      self.gf('django.db.models.fields.CharField')(default='personal', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyClasses.personal_or_group'
        db.delete_column(u'forcompany_companyclasses', 'personal_or_group')
