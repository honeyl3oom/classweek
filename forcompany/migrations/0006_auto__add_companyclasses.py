...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyClasses'
        db.create_table(u'forcompany_companyclasses', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('sub_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['classes.SubCategory'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'forcompany', ['CompanyClasses'])


    def backwards(self, orm):
        # Deleting model 'CompanyClasses'
        db.delete_table(u'forcompany_companyclasses')
