...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyClasses.user'
        db.add_column(u'forcompany_companyclasses', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=17, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyClasses.user'
        db.delete_column(u'forcompany_companyclasses', 'user_id')
