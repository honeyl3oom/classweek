...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Schedule.startTime'
        db.alter_column(u'classes_schedule', 'startTime', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):

        # Changing field 'Schedule.startTime'
        db.alter_column(u'classes_schedule', 'startTime', self.gf('django.db.models.fields.TimeField')(auto_now=True))
