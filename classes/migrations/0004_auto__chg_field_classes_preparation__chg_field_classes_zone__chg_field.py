...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classes.personalOrGroup'
        db.alter_column(u'classes_classes', 'personalOrGroup', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Classes.personalOrGroup'
        db.alter_column(u'classes_classes', 'personalOrGroup', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'classes.classes': {
            ...
            'countOfDay': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
