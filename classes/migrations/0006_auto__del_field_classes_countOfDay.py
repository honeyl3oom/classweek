...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Classes.countOfDay'
        db.delete_column(u'classes_classes', 'countOfDay')


    def backwards(self, orm):
        # Adding field 'Classes.countOfDay'
        db.add_column(u'classes_classes', 'countOfDay',
